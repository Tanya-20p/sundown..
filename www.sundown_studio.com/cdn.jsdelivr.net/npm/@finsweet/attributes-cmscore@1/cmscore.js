...
var W = async n => {
    ...
    if (!(!t || !("destroy" in t) || !("ready" in t) || !("require" in t)) && !(n && !n.length)) {
        if (n || (t.destroy(), t.ready()), !n || n.includes("ix2")) {
            ...
            if (r) {
                let {
                    ...
                    eventState: a
                } = i.getState().ixSession, c = Object.entries(a);
                n || r.destroy(), r.init(), await Promise.all(c.map(l => i.dispatch(s.eventStateChanged(...l))))
            }
        }
        ...
        if (n != null && n.includes("lightbox") && ((e = t.require("lightbox")) == null || e.ready()), n != null && n.includes("slider")) {
            let r = t.require("slider");
            r && (r.redraw(), r.ready())
        }
        return n != null && n.includes("tabs") && ((o = t.require("tabs")) == null || o.redraw()), new Promise(r => t.push(() => r(void 0)))
    }
};
...
var x = class {
    constructor(t, e, o) {
        ...
        this.valid = !0;
        var i;
        this.href = (i = t.querySelector("a")) == null ? void 0 : i.href, this.currentIndex = [...e.children].indexOf(t);
...
function Bt(n, t, e) {
    let o = T.get(n);
    if (o.has(t))
        for (let r of o.get(t)) r.enqueue(e);
    if (o.has(F)) {
...
function pt(n, t) {
    ...
    return {
        async next() {
            return r ? r.length === 0 ? e ? (r = void 0, this.next()) : (await new Promise(s => {
                o = s
            }), this.next()) : {
                done: !1,
                value: await r.shift()
...
function ut(n) {
    ...
    for (let t of n)
        if (!mt.includes(t)) throw typeof t != "string" ? new TypeError("`methodNames` element must be a string") : new Error(`${t} is not Emittery method`);
    return n
}
var _ = n => n === $ || n === k;
...
var y = class {
        static mixin(t, e) {
            return e = ut(e), o => {
                ...
                for (let s of e)
                    if (o.prototype[s] !== void 0) throw new Error(`The property \`${s}\` already exists on \`target\``);
                ...
                for (let s of e) Object.defineProperty(o.prototype, s, {
                    enumerable: !1,
                    value: i(s)
                });
                return o
        ...
        constructor(t = {}) {
            var e;
            S.set(this, new Set), C.set(this, new Map), T.set(this, new Map), T.get(this).set(F, new Set), this.debug = (e = t.debug) != null ? e : {}, this.debug.enabled === void 0 && (this.debug.enabled = !1), this.debug.logger || (this.debug.logger = (o, r, i, s) => {
                try {
                    s = JSON.stringify(s)
                } catch {
	...
	data: ${s}`)
        ...
        on(t, e) {
            ...
            for (let o of t) {
                L(o);
                let r = M(this, o);
                r || (r = new Set, C.get(this).set(o, r)), r.add(e), this.logIfDebugEnabled("subscribe", o, void 0), _(o) || H(this, $, {
                    eventName: o,
                    listener: e
                })
            }
        ...
        off(t, e) {
            ...
            for (let o of t) {
                L(o);
                let r = M(this, o);
                r && (r.delete(e), r.size === 0 && C.get(this).delete(o)), this.logIfDebugEnabled("unsubscribe", o, void 0), _(o) || H(this, k, {
                    eventName: o,
                    listener: e
                })
            }
        ...
        async emit(t, e) {
            var a;
            if (L(t), _(t) && !V) throw new TypeError("`eventName` cannot be meta event `listenerAdded` or `listenerRemoved`");
            this.logIfDebugEnabled("emit", t, e), Bt(this, t, e);
            let o = (a = M(this, t)) != null ? a : new Set,
                r = S.get(this),
                i = [...o],
                s = _(t) ? [] : [...r];
            await lt, await Promise.all([...i.map(async c => {
        ...
        onAny(t) {
            return j(t), this.logIfDebugEnabled("subscribeAny", void 0, void 0), S.get(this).add(t), H(this, $, {
                listener: t
        ...
        offAny(t) {
            j(t), this.logIfDebugEnabled("unsubscribeAny", void 0, void 0), H(this, k, {
                listener: t
            }), S.get(this).delete(t)
        }
        clearListeners(t) {
...
var bt = async (n, {
    ...
    if (!e && !c.some(([p]) => p) || !n.some(({
            needsWebflowRestart: p
        }) => p)) return;
    for (let p of t) {
        let u = n.includes(p);
...
var yt = async (n, t = !1, e = !0) => {
        ...
        let h = e && !t || c !== m;
        return h && await n.displayElement(c ? "emptyElement" : "list", !1), await Promise.all([...vt(p, n, t), ...Wt(d, n, t)]), await n.emitSerial("renderitems", u), await bt(u, n), h && await n.displayElement(m ? "emptyElement" : "list"), u
    },
    vt = (n, {
        itemsAnimation: t
    }, e) => n.map(async o => {
        ...
        r.animating = new Promise(async c => {
            r.rendering = new Promise(async l => {
                ...
                let {
                    element: p,
                    currentIndex: u
                } = r, m = (s == null ? void 0 : s.element) || null;
                if (!B(u) && o && e) {
                    let {
                        prepareIn: d,
                        animateIn: h,
                    ...
                    d(p, R), Et(p), l(), f && await G(f * a), await h(p, { ...R,
                        prepared: !0
                    })
                } else m ? t.insertBefore(p, m.nextSibling) : t.prepend(p), Et(p), l();
                c()
            })
        }), await r.rendering, r.currentIndex = i
    }) : [],
    Et = n => {
...
var v = class extends y {
    constructor(e, o) {
        ...
        this.cacheItems = !0;
        let r = b(e, "list");
        this.list = r, this.paginationWrapper = b(e, "pagination"), this.paginationNext = b(e, "next"), this.paginationPrevious = b(e, "previous"), this.paginationCount = b(e, "pageCount"), this.emptyElement = b(e, "empty");
        let i = b(e, "items");
        this.itemsPerPage = this.originalItemsPerPage = i.length, this.totalPages = 1, gt(this);
        let s = [];
        r && s.push(...i.map(a => new x(a, r))), this.items = s, this.validItems = s, this.originalItemsOrder = [...s]
    }
    async addItems(e, o = "push") {
        let {
            items: r,
            list: i,
            originalItemsOrder: s
        } = this;
        if (!i) return;
        let a = e.map(c => new x(c, i));
        for (let c of [r, s]) c[o](...a);
        await this.emit("shouldnest", a), await this.emit("shouldcollectprops", a), await this.emit("shouldsort", a), await this.emit("shouldfilter"), await this.renderItems(!0), await this.emit("additems", a)
    }
    async addStaticItems(e) {
        ...
        r.sort((c, l) => c.staticIndex - l.staticIndex), await this.emit("shouldnest", a), await this.emit("shouldcollectprops", a), await this.emit("shouldsort", a), await this.emit("shouldfilter"), await this.renderItems(!0), await this.emit("additems", a)
    }
    restoreItemsOrder() {
    ...
    async clearItems(e = !0) {
        if (e)
            for (let {
                    element: o
                } of this.items) o.remove();
        this.items = [], this.staticItems = [], this.originalItemsOrder = [], await this.renderItems(!1, !1)
    }
    async renderItems(e, o) {
        return await this.renderingQueue, new Promise(async r => {
            let i = yt(this, e, o);
    ...
    async switchPage(e, o = !0) {
        let {
            currentPage: r,
            showPaginationQuery: i
        } = this;
        e !== r && (await this.emit("switchpage", e), this.currentPage = e, this.scrollToAnchor(), i && ht(this), o && await this.renderItems())
    }
    initPagination(e) {
    ...
    addPaginationButton(e, o, r) {
        ...
        !i || this[o] || r < 0 || (e.style.display = "none", i.insertBefore(e, i.children[r]), this[o] = e)
    }
    addEmptyElement(e) {
        let {
            wrapper: o,
        ...
        i || (e.style.display = "none", o.insertBefore(e, (r == null ? void 0 : r.nextSibling) || null), this.emptyElement = e)
    }
    addLoader(e) {
        let {
            loader: o
    ...
    destroy() {
        var e, o;
        this.clearListeners(), (o = (e = window.fsAttributes.cmscore) == null ? void 0 : e.listInstances) == null || o.delete(this.wrapper)
    }
};
...
var Ht = async (n, {
        ...
        let {
            ...
            listAnimation: s
        } = n, a = n.getAttribute(t), c = n.getAttribute(e);
        if (s && !a && !c) return;
    ...
    Ft = async (n, {
        ...
        let {
            animations: s,
            easings: a
        } = i, c = n.getAttribute(t), l = O(c, z(s)) ? s[c] : s.fade, p = n.getAttribute(e), u = n.getAttribute(o), m = n.getAttribute(r);
        n.itemsAnimation = { ...l,
            options: {
...
export {
    x as CMSItem, v as CMSList, Ft as addItemsAnimation, Ht as addListAnimation, $t as checkCMSCoreVersion, Tt as createCMSListInstance, Nt as createCMSListInstances, At as version
};